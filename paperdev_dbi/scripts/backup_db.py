...
def paperbackup(timestamp):
	...
	backup_dir = os.path.join('/data4/paper/paperdev_backup', str(timestamp))
...
if __name__ == '__main__':
	...
	#backup_file = '/data4/paper/paperdev_backup/{timestamp}/paperdev_backup.psv'.format(timestamp=timestamp)
