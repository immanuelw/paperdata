...
def gcal2jd(year, month, day, hour=None, minute=None, second=None):
	...
	input: year, month, day, hour, minute, second all as integers
	output: modified jd, julian date as 5 sig fig float
	'''
	year = int(year)
	month = int(month)
	day = int(day)
...
def jd2gcal(jd1, jd2):
	...
	input: modified jd, julian date
	output: integer values of year, month, and day, and fractional value of the gregorian day
	'''
