...
dbnum = '/data2/home/immwa/scripts/paperdata/backups/paperfeed_backup_%s.csv'%(time_date)
...
cursor.execute('SELECT * FROM paperfeed order by julian_date asc, raw_location asc, path asc')
