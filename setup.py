...
setup_args = {
	...
	'packages' : find_packages(exclude=['flask-paper/*']),
	#['paperdata', 'paperdata.data', 'paperdata.ganglia', 'paperdata.dev', 'paperdata.convert'],
	'install_requires': ['alembic>=0.8.2', 'Flask>=0.10.1', 'Flask-Login>=0.2.11', 'Flask-Migrate>=1.5.1', 'Flask-Script>=2.0.5',
							...
							'SQLAlchemy>=1.0.8', 'Werkzeug>=0.10.4', 'wheel>=0.24.0'],
	'version': __version__,
}
