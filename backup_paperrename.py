...
dbnum = '/data2/home/immwa/scripts/paperdata/backups/paperrename_backup_%s.csv'%(time_date)
...
cursor.execute('SELECT * FROM paperrename order by julian_date asc, raw_location asc, path asc')
