...
if False:
    ...
    cl.done()
    cl.addcomponent(dir=fornaxAi, flux=43, fluxunit='Jy', freq='0.150GHz', shape="Gaussian", majoraxis="0.1arcmin", minoraxis='0.1arcmin', positionangle='0deg')
    cl.addcomponent(dir=fornaxAii, flux=86, fluxunit='Jy', freq='0.150GHz', shape="Gaussian", majoraxis="0.1arcmin", minoraxis='0.1arcmin', positionangle='0deg')
...
bandpass_table=filename+'_bandpass.cal'
...
clean(vis=filename_raw,imagename=filename_raw+'_image',imagermode='csclean',psfmode='clark',threshold='10Jy',niter=10000,mode='mfs',weighting='uniform',cell=['3arcmin','3arcmin'],imsize=[1024,1024],gridmode='widefield',wprojplanes=32,gain=0.2,stokes='I')

clean2fits(filename_raw+'_image',filename_raw+'_image')
